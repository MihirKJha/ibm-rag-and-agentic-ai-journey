...
def load_food_data(file_path: str) -> List[Dict]:
    ...
    try:
        ...
        for i, item in enumerate(food_data):
            ...
            if 'food_category' not in item:
                item['food_category'] = 'Unknown'
...
def populate_similarity_collection(collection, food_items: List[Dict]):
    ...
    for i, food in enumerate(food_items):
        ...
        text += f"Cooking method: {food.get('cooking_method', 'Unknown')}. "
        text += f"Food category: {food.get('food_category', 'Unknown')}. "
        ...
        metadatas.append({
            ...
            "description": food.get("food_description", "Unknown"),
            "cooking_method": food.get("cooking_method", "Unknown"),
            "health_benefits": food.get("food_health_benefits", "Unknown"),
            "taste_profile": food.get("taste_profile", "Unknown"),
            "food_category": food.get("food_category", "Unknown")
        })
    ...
    try:
        ...
        for i in range(len(results['ids'][0])):
            ...
            result = {
                ...
                'food_category': results['metadatas'][0][i]['food_category'],
    ...
    try:
        ...
        for i in range(len(results['ids'][0])):
            ...
            result = {
                ...
                'similarity_score': similarity_score,
                'distance': results['distances'][0][i],
                'food Category': results['metadatas'][0][i]['food_category']
            }
