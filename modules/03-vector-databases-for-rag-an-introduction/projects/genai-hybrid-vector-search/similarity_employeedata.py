...
def main():
    try:
        ...
        collection = client.create_collection(
            ...
            metadata={"description": "A collection for storing employee records"},
            configuration={
              "hnsw": {"space": "cosine"},
        ...
        # These documents will be used for similarity search based on skills, 
        # roles, and experience
        employee_documents = []
        for employee in create_employee_data():
        ...
        collection.add(
            ...
            ids=[employee["id"] for employee in create_employee_data()],
...
# Defining a function to create comprehensive employee data
